        ...
        <div className="flex flex-col items-center justify-center gap-6 text-center">
            ...
            >
                ...
                className="relative px-6 py-2 text-base font-medium bg-white rounded-full group-hover:bg-gray-50 transition-colors duration-200">
                    ...
                    <p className="text-base text-rose-300">AI-Powered Content Creation</p>
                </Badge>
            </MotionDiv>
            <MotionDiv variants={itemsVariants} className="capitalize text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
                Start Uploading  
            ...
            <MotionDiv variants={itemsVariants} className="mt-2 text-lg leading-8 text-gray-600 max-w-2xl text-center">
                <p>
