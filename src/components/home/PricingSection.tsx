...
import { containerVariants, itemsVariants, pricingPlans } from "@/utils/constants";
        ...
        >
            ...
            >
                ...
                <MotionDiv variants={listVariant} className="space-y-2 flex justify-center w-full">
                    ...
                    href={paymentLink}
                    className={cn(
                        "w-full rounded-full flex items-center justify-center gap-2 bg-linear-to-r from-rose-800 to-rose-500 hover:from-rose-500 hover:to-rose-800 text-white border-2 py-2" ,(id==='pro') ? 
                        ("border-rose-900"):
    ...
    return(
        ...
        >
            <div className="py-12 lg:py-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 lg:pt-12">
                <MotionDiv variants={itemsVariants} className="flex items-center justify-center w-full pb-12 ">
                    <h2 className="font-bold text-xl mb-8 text-rose-500">PRICING</h2>
                </MotionDiv>
