...
export default function HeroSection(){
    return(
        <section className="flex flex-col z-0 mx-auto justify-center items-center relative py-16 sm:py-20 lg:pb-28 transition-all animate-in lg:px-12 max-w-7xl">
            ...
            <h1 className="font-bold px-6 text-center">
                Transform PDFs into 
