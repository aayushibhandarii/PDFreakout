...
import { MotionDiv, MotionH1, MotionH2, MotionSection, MotionSpan } from "../common/MotionWrapper";
...
export default function HeroSection(){
    return(
        ...
        initial="hidden"
        animate="visible"
        className="flex flex-col z-0 mx-auto justify-center items-center relative py-16 sm:py-20 lg:pb-28 transition-all animate-in lg:px-12 max-w-7xl">
            <MotionDiv
             ...
             className="relative p-[1px] overflow-hidden rounded-full bg-linear-to-r from-rose-200 via-rose-500 to-rose-800 animate-gradient-x group">
                    ...
                    className="relative px-6 py-2 text-base font-medium bg-white rounded-full group-hover:bg-gray-50 transition-colors duration-200">
                        ...
                        <p className="text-base text-rose-300">Powered by AI</p>
                    </Badge>
                    
            </MotionDiv>
            <MotionH1 variants={itemsVariants} className="font-bold px-6 text-center">
                Transform PDFs into 
                <span className="relative inline-block">
                    
                    <MotionSpan 
                    whileHover={buttonVariants} className="relative z-10 px-2"> concise </MotionSpan>
                    <span className="absolute inset-0 bg-rose-200/50 -rotate-2 rounded-lg transform -skew-y-1 " aria-hidden="true"></span> 
                </span>
                summaries
            </MotionH1>
            <MotionH2 variants={itemsVariants} className="text-lg sm:text-xl lg-text-2xl text-center px-4 lg:px-0 lg:max-w-4xl text-gray-600">
            ...
            <MotionDiv variants={itemsVariants} whileHover={buttonVariants}>
                ...
                ">   {/* as this button is going to redirect the user that's why it has variant as link */}
                    <Link href="/#pricing" className="flex gap-2 items-center">
                        <span>Try PDFreakout</span> 
