...
export function NavigationControls({
    ...
    return(
        <div className="absolute bottom-0 left-0 right-0 p-4 bg-background/80 backdrop-blur-xs border-t border-rosse-500/10">
            <div className="flex justify-between items-center">
                ...
                className={cn(
                    ...
                    currentSection===0?"opacity-50":"hover:bg-red-500/20"
                )}>
                ...
                className={cn(
                    "rounded-full w-12 h-12 transition-all duration-200 bg-linear-to-br from-rose-500 to-rose-600 backdrop-blur-xs border border-rose-500/10",
                    currentSection===totalSections-1?"opacity-50":"hover:bg-red-500/20"
                )}>
